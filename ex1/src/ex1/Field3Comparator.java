...
public class Field3Comparator implements Comparator<Record> {
    ...
    /**
     *  It compare two element (of type Field3) of the CSV file.
     * @param el1: the first element of Field3 to be compared
     * @param el2: the second element of Field3 to be compared
